...
as select * from csvread(
  './h2/test/csv/title_principal.csv', 
  null, 'charset=UTF-8 nullString=\\N')
;
...
as select * from csvread(
  './h2/test/csv/title_aka_title_type.csv', 
  null, 'charset=UTF-8 nullString=\\N')
;
